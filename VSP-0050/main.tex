...
In \href{\xmbaseurl/VSP-0020/main}{Subspaces of $\RR^n$} we discussed $\RR^n$ as a vector space and introduced the notion of a subspace of $\RR^n$.  
...
and satisfies the following properties:
  ...
  \begin{remark}
      All scalars in this chapter are assumed to be real numbers.  Complex scalars are considered in \href{\xmbaseurl/RTH-0050/main}{Complex Matrices}.
  \end{remark}
...
Let $\mathbb{M}_{m,n}$ be the set of all $m\times n$ matrices.  Matrix addition and scalar multiplication were defined in \href{\xmbaseurl/MAT-0010/main}{Addition and Scalar Multiplication of Matrices}.
