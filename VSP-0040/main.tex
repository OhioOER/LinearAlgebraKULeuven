...
This result was first introduced without proof in \href{\xmbaseurl/SYS-0030/main}{Gaussian Elimination and Rank} where we used it to define the \dfn{rank} of a matrix as the number of nonzero rows in its row-echelon forms.  We can now update the definition of rank as follows.
