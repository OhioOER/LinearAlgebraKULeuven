...
\subsection{A}
\href{\xmbaseurl/VEC-0030/main}{addition of vectors}

%adjoint of a matrix

\href{\xmbaseurl/DET-0060/main}{adjugate of a matrix}

\href{\xmbaseurl/EIG-0020/main}{algebraic multiplicity of an eigenvalue}
...
\href{\xmbaseurl/SYS-0020/main}{augmented matrix}


\subsection{B}

\href{\xmbaseurl/SYS-0020/main}{back substitution}
...
\href{\xmbaseurl/MAT-0023/main}{block matrices}

\href{\xmbaseurl/DET-0070/main}{box product}
...
\href{\xmbaseurl/EIG-0020/main}{characteristic polynomial}

\href{\xmbaseurl/RTH-0045/main}{Cholesky factorization}
...
\href{\xmbaseurl/LTR-0010/main}{codomain of a linear transformation}

\href{\xmbaseurl/SYS-0020/main}{coefficient matrix}

\href{\xmbaseurl/DET-0010/main}{cofactor expansion}

%cofactor of a square matrix %see 7.6 LaPlace Expansion

\href{\xmbaseurl/MAT-0010/main}{column matrix (vector)}
...
\href{\xmbaseurl/SYS-0010/main}{consistent system}

\href{\xmbaseurl/SYS-0040/main}{convergence}

coordinate vector with respect to a basis (\href{\xmbaseurl/VSP-0030/main}{in $\RR^n$}) (\href{\xmbaseurl/VSP-0060/main}{abstract vector spaces})

\href{\xmbaseurl/DET-0060/main}{Cramer's Rule}
...
\href{\xmbaseurl/MAT-0025/main}{diagonal matrix}
...
\href{\xmbaseurl/RRN-0020/main}{Direction vector}
...
\href{\xmbaseurl/VEC-0070/main}{Distance between point and line}

\href{\xmbaseurl/SYS-0040/main}{divergence}

\href{\xmbaseurl/LTR-0010/main}{domain of a linear transformation} 
...
\href{\xmbaseurl/EIG-0040/main}{equivalence relation}
...
\href{\xmbaseurl/SYS-0020/main}{free variable}

\href{\xmbaseurl/VSP-0040/main}{fundamental subspaces of a matrix}
...
\href{\xmbaseurl/SYS-0040/main}{Gauss-Seidel method}
...
\href{\xmbaseurl/EIG-0080/main}{Gerschgorin's Disk Theorem}

\href{\xmbaseurl/RTH-0015/main}{Gram-Schmidt Process}
...
\href{\xmbaseurl/RRN-0030/main}{hyperplane}

\subsection{I}

\href{\xmbaseurl/MAT-0020/main}{identity matrix}
...
\href{\xmbaseurl/SYS-0010/main}{inconsistent system}
...
\href{\xmbaseurl/VSP-0070/main}{inner product space}
...
\href{\xmbaseurl/SYS-0040/main}{iterative methods}

\subsection{J}

\href{\xmbaseurl/SYS-0040/main}{Jacobi's method}
...
\href{\xmbaseurl/SYS-0020/main}{leading variable}
...
linear transformation (\ref{def:lin}) (also see \href{\xmbaseurl/LTR-0022/main}{Linear Transformations of Abstract Vector Spaces})
\begin{expandable}
...
\href{\xmbaseurl/MAT-0070/main}{lower triangular matrix}

\href{\xmbaseurl/MAT-0070/main}{LU factorization}
...
\href{\xmbaseurl/MAT-0010/main}{main diagonal}
    
\href{\xmbaseurl/MAT-0010/main}{matrix}
...
\href{\xmbaseurl/DET-0010/main}{minor of a square matrix}
...
\href{\xmbaseurl/RRN-0030/main}{normal vector}
...
\href{\xmbaseurl/VSP-0060/main}{ordered basis}

\href{\xmbaseurl/RTH-0010/main}{orthogonal basis}
...
\href{\xmbaseurl/RTH-0010/main}{orthonormal basis}
...
\href{\xmbaseurl/SYS-0050/main}{particular solution}

\href{\xmbaseurl/MAT-0023/main}{partitioned matrices (block multiplication)}

\href{\xmbaseurl/MAT-0070/main}{permutation matrix}

\href{\xmbaseurl/SYS-0030/main}{pivot}
...
\href{\xmbaseurl/EIG-0070/main}{power method (and its variants)}
...
\href{\xmbaseurl/EIG-0070/main}{Rayleigh quotients}
...
\href{\xmbaseurl/SYS-0020/main}{row equivalent matrices}

\href{\xmbaseurl/MAT-0010/main}{row matrix (vector)}
...
\subsection{S}
\href{\xmbaseurl/VEC-0010/main}{Scalar}

\href{\xmbaseurl/DET-0070/main}{scalar triple product}
...
\href{\xmbaseurl/RTH-0060/main}{singular value decomposition (SVD)}
...
\href{\xmbaseurl/VEC-0090/main}{spanning set}
...
\href{\xmbaseurl/RTH-0035/main}{Spectral Theorem}

\href{\xmbaseurl/RTH-0035/main}{spectrum} 
...
\href{\xmbaseurl/VEC-0010/main}{Standard Position}
...
\href{\xmbaseurl/MAT-0010/main}{square matrix}
...
\href{\xmbaseurl/VEC-0030/main}{Subtraction of vectors}
...
\href{\xmbaseurl/SYS-0010/main}{system of linear equations}
...
\href{\xmbaseurl/APX-0010/main}{triangle inequality}

\subsection{U}
\href{\xmbaseurl/VEC-0036/main}{Unit Vector}

\href{\xmbaseurl/MAT-0070/main}{upper triangular matrix}

\subsection{V}
\href{\xmbaseurl/VEC-0010/main}{Vector}
...
vector space (\href{\xmbaseurl/VSP-0020/main}{$\RR^n$})
