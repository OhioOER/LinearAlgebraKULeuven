...
The following set of problems deals with geometric interpretation of eigenvalues and eigenvectors, as well as linear transformations of the plane.  Please use \href{\xmbaseurl/EIG-0010/main}{Describing Eigenvalues and Eigenvectors Algebraically and Geometrically} and \href{\xmbaseurl/LTR-0070/main}{Geometric Transformations of the Plane} for reference.
...
Explain why $\lambda$ is a real number if and only if $\theta$ is a multiple of $\pi$.  (Compare this to Practice Problem \ref{prob:rotmatrixrealeig1} of \href{\xmbaseurl/EIG-0010/main}{Describing Eigenvalues and Eigenvectors Algebraically and Geometrically}.)
