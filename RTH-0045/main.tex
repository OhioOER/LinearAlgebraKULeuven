...
statistics (for example, in factor analysis used in the social sciences)
 and in geometry (quadratic forms, for instance). We will encounter them again in \href{\xmbaseurl/VSP-0070/main}{Inner Product Spaces} when describing all inner products in $\RR^n$.
...
The next example of a positive definite matrix is one we will see again in \href{\xmbaseurl/RTH-0060/main}{SVD Decomposition}
