...
\begin{explanation}
We perform Gauss-Jordan elimination by applying elementary row operations as described in \href{\xmbaseurl/SYS-0030/main}{Gaussian Elimination and Rank}.  
\begin{equation*}
...
There are many situations where iterative methods are, in fact, the best methods we have for performing computations.  We will see a nice example of this later when we study \href{\xmbaseurl/EIG-0070/main}{The Power Method and the Dominant Eigenvalue}.
...
We need the following definition, which will also be useful when we study \href{\xmbaseurl/EIG-0080/main}{Gershgorin's Theorem}.
