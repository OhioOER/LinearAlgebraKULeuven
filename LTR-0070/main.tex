...
When a point is reflected about a line, its image is located on the opposite side of the line and the same distance away from the line as the original point.  This is another example of a matrix transformation.  (We will prove that this is a matrix transformation in Problem \ref{prob:linOfRotRef} of \href{\xmbaseurl/SUPX-0060/main}{Additional Exercises}.)
