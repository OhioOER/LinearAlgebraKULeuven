...
For \ref{th:properties_similar_det}, $\det B = \det(P^{-1}) \det A \det P = \det A$ because $\det(P^{-1}) = 1/ \det P$ (Theorem \ref{th:detofinverse}). %and determinants commute (see \href{\xmbaseurl/DET-0040/main}{Properties of the Determinant}).
