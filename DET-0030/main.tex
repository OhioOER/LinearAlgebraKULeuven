...
\end{enumerate}
\end{theorem}
The proof of this theorem is relegated to \href{\xmbaseurl/DET-0050/main}{Tedious Proofs Concerning Determinants}.  For a sketch of the proof, you can watch this video:
\youtube{y0XVK-ey30c}
