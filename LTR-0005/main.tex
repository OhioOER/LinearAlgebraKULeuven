...
Restating properties \ref{item:matrixproperties1} and \ref{item:matrixproperties4} of Section \href{\xmbaseurl/MAT-0020/main}{Matrix Multiplication} in terms of matrix-vector multiplication gives us
