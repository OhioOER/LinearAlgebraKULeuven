...
Note to Student:  In this section we will often use $U$, $V$ and $W$ to denote subspaces of $\RR^n$, or any other finite-dimensional vector space, such as those we study in \href{\xmbaseurl/XLAChapter_vecSpaces/main}{Vector Spaces}. 
